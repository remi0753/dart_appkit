...
static_assert(std::is_standard_layout_v<DaServicesTextRequestorConfiguration>);
...
static_assert(DA_EVENT_PROTOCOL_VERSION_CURRENT == 15);
static_assert(DA_EVENT_APPLICATION_POWER_STATE_CHANGED == 35);
static_assert(DA_EVENT_APPLICATION_SCREEN_SET_CHANGED == 36);
static_assert(DA_EVENT_APPLICATION_MEMORY_PRESSURE_CHANGED == 37);
static_assert(DA_APPLICATION_POWER_STATE_WILL_SLEEP == 0);
static_assert(DA_APPLICATION_POWER_STATE_DID_WAKE == 1);
static_assert(DA_MEMORY_PRESSURE_NORMAL == 0);
static_assert(DA_MEMORY_PRESSURE_WARNING == 1);
static_assert(DA_MEMORY_PRESSURE_CRITICAL == 2);
