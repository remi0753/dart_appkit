...
| v15 generic application system state | Workspace sleep/wake and AppKit screen-set notification lifecycle, dispatch memory-pressure level/deduplication injection, shutdown isolation, exact shared encoder records, v14 filtering, and strict Dart typed-stream/malformed-source tests | Verified |
